...
int main(void)
{
	...
	get_data("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/models/conv1_weights.txt", 0, weights);
	get_data("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/models/primcaps_weights.txt", conv1_num_weights, weights);
	get_data("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/models/digitcaps_weights.txt", conv1_num_weights + primary_caps_num_weights, weights);

	get_data("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/models/conv1_biases.txt", 0, biases);
	get_data("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/models/primcaps_biases.txt", CONV1_FILTERS, biases);

	get_data_n("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/datasets/MNIST/testimg.txt", IN_IMG_ROWS * IN_IMG_COLS * IN_IMG_DEPTH * NUM_IMAGES_TO_TEST, images);
	get_data_n("/home/jjos425/Documents/vivado_projects/project_1/CapsuleNetworkAccelerator/datasets/MNIST/labels.txt", NUM_IMAGES_TO_TEST, labels);
    labels[0] = 0;
