...
entity process_features_control_s_axi is
generic (
...
end entity process_features_control_s_axi;
...
architecture behave of process_features_control_s_axi is
    ...
    constant ADDR_BIASES_DATA_0   : INTEGER := 16#28#;
    constant ADDR_BIASES_DATA_1   : INTEGER := 16#2c#;
    constant ADDR_BIASES_CTRL     : INTEGER := 16#30#;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_biases(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_biases(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
