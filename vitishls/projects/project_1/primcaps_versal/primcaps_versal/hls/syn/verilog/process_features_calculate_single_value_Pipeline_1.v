...
wire   [0:0] icmp_ln125_fu_1888_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [6:0] arrayinit_curidx_fu_336;
wire   [6:0] add_ln125_fu_1479_p2;
wire    ap_loop_init;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln125_fu_1888_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln125_fu_1888_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln125_fu_1479_p2 = (ap_sig_allocacmp_arrayinit_curidx_load + 7'd1);
...
assign icmp_ln125_fu_1888_p2 = ((ap_sig_allocacmp_arrayinit_curidx_load == 7'd80) ? 1'b1 : 1'b0);
