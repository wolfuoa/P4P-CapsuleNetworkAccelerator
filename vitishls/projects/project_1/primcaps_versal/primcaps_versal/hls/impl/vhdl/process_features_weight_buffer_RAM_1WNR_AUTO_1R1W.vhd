...
entity process_features_weight_buffer_RAM_1WNR_AUTO_1R1W is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 2592; 
        AddressWidth    : integer   := 8;
        AddressRange    : integer   := 256;
        COL_WIDTH       : integer := 8;
        NUM_COL         : integer := 2592/8
    ); 
    port (
...
architecture rtl of process_features_weight_buffer_RAM_1WNR_AUTO_1R1W is 
