...
#define PRIMARY_CAPS_FILTERS			256
...
#define PRIMARY_CAPS_CONV_STRIDE_WIDTH	12
#define PRIMARY_CAPS_CONV_STRIDE_LENGTH 12
...
#define DIGIT_CAPS_INPUT_DIM_CAPSULE 8

#define OUT_IMG_ROWS				 20
#define OUT_IMG_COLS				 20
#define OUT_IMG_DEPTH				 1
