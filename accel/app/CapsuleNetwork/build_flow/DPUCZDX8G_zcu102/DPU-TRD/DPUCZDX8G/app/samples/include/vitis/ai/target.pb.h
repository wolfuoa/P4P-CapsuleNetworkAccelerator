...
class Target_Load_ConstantPadLoadMode;
struct Target_Load_ConstantPadLoadModeDefaultTypeInternal;
TARGET_FACTORY_DLLESPEC extern Target_Load_ConstantPadLoadModeDefaultTypeInternal _Target_Load_ConstantPadLoadMode_default_instance_;
...
template<> TARGET_FACTORY_DLLESPEC ::vitis::ai::Target_Load_ConstantPadLoadMode* Arena::CreateMaybeMessage<::vitis::ai::Target_Load_ConstantPadLoadMode>(Arena*);
...
class TARGET_FACTORY_DLLESPEC Target_Load_ConstantPadLoadMode final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:vitis.ai.Target.Load.ConstantPadLoadMode) */ {
 public:
  inline Target_Load_ConstantPadLoadMode() : Target_Load_ConstantPadLoadMode(nullptr) {}
  ~Target_Load_ConstantPadLoadMode() override;
  explicit constexpr Target_Load_ConstantPadLoadMode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Target_Load_ConstantPadLoadMode(const Target_Load_ConstantPadLoadMode& from);
  Target_Load_ConstantPadLoadMode(Target_Load_ConstantPadLoadMode&& from) noexcept
    : Target_Load_ConstantPadLoadMode() {
    *this = ::std::move(from);
  }

  inline Target_Load_ConstantPadLoadMode& operator=(const Target_Load_ConstantPadLoadMode& from) {
    CopyFrom(from);
    return *this;
  }
  inline Target_Load_ConstantPadLoadMode& operator=(Target_Load_ConstantPadLoadMode&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Target_Load_ConstantPadLoadMode& default_instance() {
    return *internal_default_instance();
  }
  static inline const Target_Load_ConstantPadLoadMode* internal_default_instance() {
    return reinterpret_cast<const Target_Load_ConstantPadLoadMode*>(
               &_Target_Load_ConstantPadLoadMode_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(Target_Load_ConstantPadLoadMode& a, Target_Load_ConstantPadLoadMode& b) {
    a.Swap(&b);
  }
  inline void Swap(Target_Load_ConstantPadLoadMode* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(Target_Load_ConstantPadLoadMode* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline Target_Load_ConstantPadLoadMode* New() const final {
    return new Target_Load_ConstantPadLoadMode();
  }

  Target_Load_ConstantPadLoadMode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Target_Load_ConstantPadLoadMode>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Target_Load_ConstantPadLoadMode& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const Target_Load_ConstantPadLoadMode& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Target_Load_ConstantPadLoadMode* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "vitis.ai.Target.Load.ConstantPadLoadMode";
  }
  protected:
  explicit Target_Load_ConstantPadLoadMode(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  enum : int {
    kLoadModeFieldNumber = 1,
  };
  // bool load_mode = 1;
  void clear_load_mode();
  bool load_mode() const;
  void set_load_mode(bool value);
  private:
  bool _internal_load_mode() const;
  void _internal_set_load_mode(bool value);
  public:

  // @@protoc_insertion_point(class_scope:vitis.ai.Target.Load.ConstantPadLoadMode)
 private:
  class _Internal;
...
class TARGET_FACTORY_DLLESPEC Target_Load final :
 ...
 public:
  ...
  typedef Target_Load_ConstantPadLoadMode ConstantPadLoadMode;
  ...
  enum : int {
    ...
    kConstantPadLoadModeFieldNumber = 6,
  ...
  // .vitis.ai.Target.Load.ConstantPadLoadMode constant_pad_load_mode = 6;
  bool has_constant_pad_load_mode() const;
  private:
  bool _internal_has_constant_pad_load_mode() const;
  public:
  void clear_constant_pad_load_mode();
  const ::vitis::ai::Target_Load_ConstantPadLoadMode& constant_pad_load_mode() const;
  PROTOBUF_MUST_USE_RESULT ::vitis::ai::Target_Load_ConstantPadLoadMode* release_constant_pad_load_mode();
  ::vitis::ai::Target_Load_ConstantPadLoadMode* mutable_constant_pad_load_mode();
  void set_allocated_constant_pad_load_mode(::vitis::ai::Target_Load_ConstantPadLoadMode* constant_pad_load_mode);
  private:
  const ::vitis::ai::Target_Load_ConstantPadLoadMode& _internal_constant_pad_load_mode() const;
  ::vitis::ai::Target_Load_ConstantPadLoadMode* _internal_mutable_constant_pad_load_mode();
  public:
  void unsafe_arena_set_allocated_constant_pad_load_mode(
      ::vitis::ai::Target_Load_ConstantPadLoadMode* constant_pad_load_mode);
  ::vitis::ai::Target_Load_ConstantPadLoadMode* unsafe_arena_release_constant_pad_load_mode();
 ...
 private:
  ...
  ::vitis::ai::Target_Load_ConstantPadLoadMode* constant_pad_load_mode_;
...
// bool load_mode = 1;
inline void Target_Load_ConstantPadLoadMode::clear_load_mode() {
  load_mode_ = false;
}
inline bool Target_Load_ConstantPadLoadMode::_internal_load_mode() const {
  return load_mode_;
}
inline bool Target_Load_ConstantPadLoadMode::load_mode() const {
  // @@protoc_insertion_point(field_get:vitis.ai.Target.Load.ConstantPadLoadMode.load_mode)
  return _internal_load_mode();
}
inline void Target_Load_ConstantPadLoadMode::_internal_set_load_mode(bool value) {
  
  load_mode_ = value;
}
inline void Target_Load_ConstantPadLoadMode::set_load_mode(bool value) {
  _internal_set_load_mode(value);
  // @@protoc_insertion_point(field_set:vitis.ai.Target.Load.ConstantPadLoadMode.load_mode)
}
...
// .vitis.ai.Target.Load.ConstantPadLoadMode constant_pad_load_mode = 6;
inline bool Target_Load::_internal_has_constant_pad_load_mode() const {
  return this != internal_default_instance() && constant_pad_load_mode_ != nullptr;
}
inline bool Target_Load::has_constant_pad_load_mode() const {
  return _internal_has_constant_pad_load_mode();
}
inline void Target_Load::clear_constant_pad_load_mode() {
  if (GetArenaForAllocation() == nullptr && constant_pad_load_mode_ != nullptr) {
    delete constant_pad_load_mode_;
  }
  constant_pad_load_mode_ = nullptr;
}
inline const ::vitis::ai::Target_Load_ConstantPadLoadMode& Target_Load::_internal_constant_pad_load_mode() const {
  const ::vitis::ai::Target_Load_ConstantPadLoadMode* p = constant_pad_load_mode_;
  return p != nullptr ? *p : reinterpret_cast<const ::vitis::ai::Target_Load_ConstantPadLoadMode&>(
      ::vitis::ai::_Target_Load_ConstantPadLoadMode_default_instance_);
}
inline const ::vitis::ai::Target_Load_ConstantPadLoadMode& Target_Load::constant_pad_load_mode() const {
  // @@protoc_insertion_point(field_get:vitis.ai.Target.Load.constant_pad_load_mode)
  return _internal_constant_pad_load_mode();
}
inline void Target_Load::unsafe_arena_set_allocated_constant_pad_load_mode(
    ::vitis::ai::Target_Load_ConstantPadLoadMode* constant_pad_load_mode) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(constant_pad_load_mode_);
  }
  constant_pad_load_mode_ = constant_pad_load_mode;
  if (constant_pad_load_mode) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:vitis.ai.Target.Load.constant_pad_load_mode)
}
inline ::vitis::ai::Target_Load_ConstantPadLoadMode* Target_Load::release_constant_pad_load_mode() {
  
  ::vitis::ai::Target_Load_ConstantPadLoadMode* temp = constant_pad_load_mode_;
  constant_pad_load_mode_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::vitis::ai::Target_Load_ConstantPadLoadMode* Target_Load::unsafe_arena_release_constant_pad_load_mode() {
  // @@protoc_insertion_point(field_release:vitis.ai.Target.Load.constant_pad_load_mode)
  
  ::vitis::ai::Target_Load_ConstantPadLoadMode* temp = constant_pad_load_mode_;
  constant_pad_load_mode_ = nullptr;
  return temp;
}
inline ::vitis::ai::Target_Load_ConstantPadLoadMode* Target_Load::_internal_mutable_constant_pad_load_mode() {
  
  if (constant_pad_load_mode_ == nullptr) {
    auto* p = CreateMaybeMessage<::vitis::ai::Target_Load_ConstantPadLoadMode>(GetArenaForAllocation());
    constant_pad_load_mode_ = p;
  }
  return constant_pad_load_mode_;
}
inline ::vitis::ai::Target_Load_ConstantPadLoadMode* Target_Load::mutable_constant_pad_load_mode() {
  ::vitis::ai::Target_Load_ConstantPadLoadMode* _msg = _internal_mutable_constant_pad_load_mode();
  // @@protoc_insertion_point(field_mutable:vitis.ai.Target.Load.constant_pad_load_mode)
  return _msg;
}
inline void Target_Load::set_allocated_constant_pad_load_mode(::vitis::ai::Target_Load_ConstantPadLoadMode* constant_pad_load_mode) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete constant_pad_load_mode_;
  }
  if (constant_pad_load_mode) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::vitis::ai::Target_Load_ConstantPadLoadMode>::GetOwningArena(constant_pad_load_mode);
    if (message_arena != submessage_arena) {
      constant_pad_load_mode = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, constant_pad_load_mode, submessage_arena);
    }
  ...
  constant_pad_load_mode_ = constant_pad_load_mode;
  // @@protoc_insertion_point(field_set_allocated:vitis.ai.Target.Load.constant_pad_load_mode)
}
